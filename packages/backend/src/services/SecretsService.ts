...
export interface Secrets {
   ...
   * (i.e. customer-managed / BYOK), 'generated' = auto-generated by DRK.
   * Absent on secrets.json files written before provenance tracking.
   */
...
export class SecretsService {
  ...
  public getEncryptionKeySource(): EncryptionKeySource {
    const s = this.load()
    if (s.keySource === 'env') return 'customer-managed'
